      ...
      <div class="container-custom">
        <div class="text-center max-w-4xl mx-auto">
          ...
          <p class="text-lg text-gray-600 max-w-3xl mx-auto">
            Activitats dissenyades per fer en família, creant vincles intergeneracionals 
            únics a través de l'artesania i la connexió amb la natura.
          </p>
        </div>
      </div>
    </section>
      ...
      <div class="container-custom text-center">
        <div class="max-w-2xl mx-auto">
          ...
          <p class="text-lg text-gray-600 mb-8">
            Estem treballant per oferir-te la millor informació sobre els nostres tallers familiars.
          </p>
