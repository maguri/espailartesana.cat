      ...
      <div class="container-custom">
        <div class="text-center max-w-4xl mx-auto">
          ...
          <p class="text-xl md:text-2xl text-gray-700 mb-8">
            Activitats de cohesió d'equip
          </p>
          <p class="text-lg text-gray-600 max-w-3xl mx-auto">
            Activitats de cohesió d'equip per a empreses i organitzacions, 
            utilitzant l'artesania com a eina per millorar la comunicació i la col·laboració.
          </p>
        </div>
      </div>
    </section>
      ...
      <div class="container-custom text-center">
        <div class="max-w-2xl mx-auto">
          ...
          <p class="text-lg text-gray-600 mb-8">
            Estem treballant per oferir-te la millor informació sobre els nostres teambuildings.
          </p>
