      ...
      <div class="container-custom">
        <div class="text-center max-w-4xl mx-auto">
          ...
          <p class="text-xl md:text-2xl text-gray-700 mb-8">
            Celebració d'aniversaris amb activitats artesanals
          </p>
          <p class="text-lg text-gray-600 max-w-3xl mx-auto">
            Celebra l'aniversari del teu fill/a amb activitats artesanals úniques i memorables 
            que combinen diversió, aprenentatge i creativitat.
          </p>
        </div>
      </div>
    </section>
      ...
      <div class="container-custom text-center">
        <div class="max-w-2xl mx-auto">
          ...
          <p class="text-lg text-gray-600 mb-8">
            Estem treballant per oferir-te la millor informació sobre els nostres aniversaris.
          </p>
