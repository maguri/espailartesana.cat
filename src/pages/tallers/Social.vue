      ...
      <div class="container-custom">
        <div class="text-center max-w-4xl mx-auto">
          ...
          <p class="text-xl md:text-2xl text-gray-700 mb-8">
            Tallers amb finalitat social i terapèutica
          </p>
          <p class="text-lg text-gray-600 max-w-3xl mx-auto">
            Tallers amb finalitat social i terapèutica per a col·lectius específics, 
            utilitzant l'artesania com a eina de transformació i benestar.
          </p>
        </div>
      </div>
    </section>
      ...
      <div class="container-custom text-center">
        <div class="max-w-2xl mx-auto">
          ...
          <p class="text-lg text-gray-600 mb-8">
            Estem treballant per oferir-te la millor informació sobre els nostres tallers socials.
          </p>
