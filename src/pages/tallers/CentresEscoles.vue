      ...
      <div class="container-custom">
        <div class="text-center max-w-4xl mx-auto">
          ...
          <p class="text-xl md:text-2xl text-gray-700 mb-8">
            Programes educatius per a centres
          </p>
          <p class="text-lg text-gray-600 max-w-3xl mx-auto">
            Programes educatius adaptats per a centres escolars i educatius, 
            integrant l'artesania i la natura en el currículum educatiu.
          </p>
        </div>
      </div>
    </section>
      ...
      <div class="container-custom text-center">
        <div class="max-w-2xl mx-auto">
          ...
          <p class="text-lg text-gray-600 mb-8">
            Estem treballant per oferir-te la millor informació sobre els nostres programes per a centres.
          </p>
